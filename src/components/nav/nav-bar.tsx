        ...
        <nav className="w-full bg-primary text-primary-foreground shadow font-[Roboto]">
            <Container className="max-w-7xl py-4">
                <div className="flex w-full items-center justify-between ">
                    ...
                    <div className="hidden items-center gap-6 lg:flex lg:ml-auto lg:translate-x-2 xl:gap-8 xl:translate-x-10">
                        {/* Navigation links */}
                            ...
                            {currentNavItems.map((item) => (
                                <Link
                                    ...
                                    className={cn(
                                        ...
                                        "before:content-[''] before:absolute before:left-0 before:-bottom-[2px] before:h-[2px] before:w-full before:rounded-[3px] before:bg-white before:transition-all",
                            ...
                            {!isLoggedIn ? (
                                <>
                                    <Button
                                        ...
                                        variant="outline"
                                        website="outline"
                                        className="rounded-[10px] border-white bg-transparent px-4 py-2 text-white shadow-none hover:bg-white hover:text-primary focus-visible:ring-[3px] focus-visible:ring-primary-foreground/50"
                                    >
                                        <Link to="/login">
                                            <svg
                                                aria-hidden="true"
                    ...
                    <button
                        ...
                        className="flex items-center justify-center rounded-md p-2 text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white lg:hidden"
                                ...
                                {!isLoggedIn ? (
                                    <>
                                        <Button
                                            ...
                                            variant="outline"
                                            website="outline"
                                            className="w-full rounded-[10px] border-white bg-transparent px-4 py-2 text-white shadow-none hover:bg-white hover:text-primary focus-visible:ring-[3px] focus-visible:ring-primary-foreground/50"
